...
public class CommandProcessor {
    ...
    public void setGroupNumber(User user) {
            db.setGroupForUser(user, "0");
    }
    ...
    public String getNextLesson(User user) {
        if(db.getGroupForUser(user).equals("0")){
            return "Введите номер группы, следующая пара которой Вас интересует.";
        } else {
            return "Запрос будет выполнен для группы " + db.getGroupForUser(user);
        }
    }
    public String getScheduleForTomorrow(User user) {
        if(db.getGroupForUser(user).equals("0")){
    ...
    public String getScheduleForWeek(User user) {
        if(db.getGroupForUser(user).equals("0")){
            return "Введите номер группы, расписание которой Вы хотите узнать";
        } else {
            return "Запрос будет выполнен для группы " + db.getGroupForUser(user);
    ...
    public String getScheduleForDay(User user) {
        if(db.getGroupForUser(user).equals("0")){
            return "Введите номер группы, расписание которой Вы хотите узнать";
        } else {
            return "Запрос будет выполнен для группы " + db.getGroupForUser(user);

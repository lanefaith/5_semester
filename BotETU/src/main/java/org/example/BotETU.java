...
public class BotETU {
    ...
    private String processCommand(String text) {
        switch (text) {
            ...
            case "/near_lesson":
                loop = 1;
                return commandProcessor.getNextLesson();
            case "/schedule_for_tomorrow":
                loop = 2;
                return commandProcessor.getScheduleForTomorrow();
            case "/schedule_for_week":
                loop = 3;
                return commandProcessor.getScheduleForWeek();
            case "/schedule_for_day":
                loop = 4;
                return commandProcessor.getScheduleForDay();
            case "/help":
                loop = 0;
    ...
    public static void main(String[] args) {
        String token = "6598438776:AAFNOwycNiJtfgovwlJ3rh3ZvgxgbQD9q4g";
